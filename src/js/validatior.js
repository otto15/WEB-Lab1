function validate(x, y, r) {
    ...
    if (!x_validation_success) {
        var elems = document.querySelectorAll(".x-dot.selected");
    ...
    if (!r_validation_success) {
        var elems = document.querySelectorAll(".r-dot.selected");
